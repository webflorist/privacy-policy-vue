...
import { openBlock, createElementBlock, createElementVNode, toDisplayString, Fragment, createTextVNode, createCommentVNode, resolveComponent, renderSlot, renderList, createBlock } from 'vue';
      ...
      ($props.type === 'third_party')
        ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ...
            createElementVNode("dd", null, [
              ...
              }, toDisplayString($props.processors[$props.cookie.processor].name), 9 /* TEXT, PROPS */, _hoisted_2$1),
              _hoisted_3$1
            ])
          ], 64 /* STABLE_FRAGMENT */))
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("section", null, [
    ...
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('gdpr_rights.title')), 1 /* TEXT */),
    ...
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('data_controller.title')), 1 /* TEXT */),
      ...
      createElementVNode("address", null, [
        ($props.dataController.organisation)
          ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString($props.dataController.organisation), 1 /* TEXT */))
          : createCommentVNode("v-if", true),
        ($props.dataController.name)
          ? (openBlock(), createElementBlock("div", _hoisted_14, toDisplayString($props.dataController.name), 1 /* TEXT */))
          : createCommentVNode("v-if", true),
        ($props.dataController.address)
          ? (openBlock(), createElementBlock("div", _hoisted_15, toDisplayString($props.dataController.address), 1 /* TEXT */))
          : createCommentVNode("v-if", true),
        ($props.dataController.email)
          ? (openBlock(), createElementBlock("div", _hoisted_16, [
              createElementVNode("a", {
                href: 'mailto:'+$props.dataController.email
              }, toDisplayString($props.dataController.email), 9 /* TEXT, PROPS */, _hoisted_17)
            ]))
          : createCommentVNode("v-if", true),
        ($props.dataController.phone)
          ? (openBlock(), createElementBlock("div", _hoisted_18, [
              ...
              }, toDisplayString($props.dataController.email), 9 /* TEXT, PROPS */, _hoisted_19)
            ]))
          : createCommentVNode("v-if", true)
      ]),
    ...
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('security.title')), 1 /* TEXT */),
    ...
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('cookies.title')), 1 /* TEXT */),
      ...
      ($props.cookies === false)
        ...
        : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.cookieTypes, (cookieType) => {
              return (openBlock(), createElementBlock("section", { key: cookieType }, [
                createElementVNode("h3", null, toDisplayString($options.t('cookies.' + cookieType + '.title')), 1 /* TEXT */),
                createElementVNode("p", {
                  innerHTML: $options.t('cookies.' + cookieType + '.content.p1')
                }, null, 8 /* PROPS */, _hoisted_26),
                (openBlock(true), createElementBlock(Fragment, null, renderList($props.cookies[cookieType], (cookie, key) => {
                  return (openBlock(), createBlock(_component_CookieDetails, {
                    key: key,
                    cookie: cookie,
                    t: $options.t,
    ...
    (Object.entries($props.dataProcessing).length > 0)
      ? (openBlock(), createElementBlock("section", _hoisted_27, [
          createElementVNode("h2", null, toDisplayString($options.t('data_processing.title')), 1 /* TEXT */),
          ...
          ($props.dataProcessing.webhosting)
            ? (openBlock(), createElementBlock("section", _hoisted_28, [
                createElementVNode("h3", null, toDisplayString($options.t('data_processing.webhosting.title')), 1 /* TEXT */),
          ...
          ($props.dataProcessing.analytics)
            ? (openBlock(), createElementBlock("section", _hoisted_35, [
                createElementVNode("h3", null, toDisplayString($options.t('data_processing.analytics.title')), 1 /* TEXT */),
          ...
          ($props.dataProcessing.maps)
            ? (openBlock(), createElementBlock("section", _hoisted_38, [
                createElementVNode("h3", null, toDisplayString($options.t('data_processing.maps.title')), 1 /* TEXT */),
          ...
          ($props.dataProcessing.send_emails)
            ? (openBlock(), createElementBlock("section", _hoisted_42, [
                createElementVNode("h3", null, toDisplayString($options.t('data_processing.send_emails.title')), 1 /* TEXT */),
      ...
      : createCommentVNode("v-if", true),
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('outgoing_links.title')), 1 /* TEXT */),
    ...
    createElementVNode("section", null, [
      createElementVNode("h2", null, toDisplayString($options.t('processor_list')), 1 /* TEXT */),
      renderSlot(_ctx.$slots, "processor_list_start"),
      (openBlock(true), createElementBlock(Fragment, null, renderList($data.usedProcessors, (processor, key) => {
        return (openBlock(), createElementBlock("section", {
          key: key,
          id: 'processor-' + key
        }, [
          createElementVNode("h3", null, toDisplayString(processor.name), 1 /* TEXT */),
          createElementVNode("dl", null, [
            createElementVNode("dt", null, toDisplayString($options.t('address')), 1 /* TEXT */),
            createElementVNode("dd", null, toDisplayString(processor.address), 1 /* TEXT */),
            createElementVNode("dt", null, toDisplayString($options.t('data_purpose.title')), 1 /* TEXT */),
            createElementVNode("dd", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(processor.purposes, (purpose, key) => {
                return (openBlock(), createElementBlock("div", { key: key }, [
                  createElementVNode("a", {
                    href: '#process-' + purpose
                  }, toDisplayString($options.t('data_purpose.' + purpose)), 9 /* TEXT, PROPS */, _hoisted_46)
                ]))
              }), 128 /* KEYED_FRAGMENT */))
            ]),
            createElementVNode("dt", null, toDisplayString($options.t('data_category.title')), 1 /* TEXT */),
            createElementVNode("dd", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(processor.data_categories, (category, key) => {
                return (openBlock(), createElementBlock("span", { key: key }, [
                  (key > 0 && key < processor.data_categories.length)
                    ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                        _hoisted_47
                      ], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */))
                    : createCommentVNode("v-if", true),
                  createTextVNode(" " + toDisplayString($options.t('data_category.' + category)), 1 /* TEXT */)
                ]))
              }), 128 /* KEYED_FRAGMENT */))
            ]),
            createElementVNode("dt", null, toDisplayString($options.t('privacy_policy')), 1 /* TEXT */),
            createElementVNode("dd", null, [
              createElementVNode("a", {
                href: processor.privacy_policy,
                target: "_blank",
                rel: "noopener nofollower"
              }, toDisplayString(processor.privacy_policy), 9 /* TEXT, PROPS */, _hoisted_48)
            ])
          ])
        ], 8 /* PROPS */, _hoisted_45))
      }), 128 /* KEYED_FRAGMENT */)),
